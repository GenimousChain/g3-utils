...
const ecc = {
   ...
   *
   * @example
   * import {privateToPublic} from "g3.js/src";
   ...
   * @example
   * import {generateKeyPairBySeed} from "g3.js/src";
   * const g3 = createG3(config)
   * g3.generateKeyPairBySeed({
    "seed": "genimouschain12345"
   * })
   */
   ...
   * @example
   * import {generateKeyPairByMnemonic} from "g3.js/src";
   * const g3 = createG3(config)
   * g3.generateKeyPairByMnemonic({
